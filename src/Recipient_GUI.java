...
public class Recipient_GUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					text = readFile("email");
					Recipient_GUI frame = new Recipient_GUI();
	...
	public Recipient_GUI() throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException {
